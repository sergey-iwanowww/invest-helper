...
alter table only public.idea_tag_links
    add constraint idea_tag_links_idea_id_ideas_id_fk foreign key (idea_id) references public.ideas(id) on
update restrict
on
delete
restrict;
...
alter table only public.idea_tag_links
    add constraint idea_tag_links_tag_id_tags_id_fk foreign key (tag_id) references public.tags(id) on
update restrict
on
delete
restrict;
...
alter table only public.ideas
    add constraint ideas_author_id_authors_id_fk foreign key (author_id) references public.authors(id) on
update restrict
on
delete
restrict;
...
alter table only public.ideas
    add constraint ideas_finish_trigger_id_idea_triggers_id_fk foreign key (finish_trigger_id) references public.idea_triggers(id) on
update restrict
on
delete
restrict;
...
alter table only public.ideas
    add constraint ideas_instrument_id_instruments_id foreign key (instrument_id) references public.instruments(id) on
update restrict
on
delete
restrict;
...
alter table only public.ideas
    add constraint ideas_source_id_sources_id foreign key (source_id) references public.sources(id) on
update restrict
on
delete
restrict;
...
alter table only public.ideas
    add constraint ideas_start_trigger_id_idea_triggers_id_fk foreign key (start_trigger_id) references public.idea_triggers(id) on
update restrict
on
delete
restrict;
...
alter table only public.source_author_links
    add constraint source_author_links_author_id_authors_id_fk foreign key (author_id) references public.authors(id) on
update restrict
on
delete
restrict;
...
alter table only public.source_author_links
    add constraint source_author_links_source_id_sources_id_fk foreign key (source_id) references public.sources(id) on
update restrict
on
delete
restrict;
